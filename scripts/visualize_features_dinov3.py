...
def main(args):
    ...
    save_path = os.path.join(args.output_dir, f"pca_evolution_dinov3_{img_basename}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", type=str, default="/home/fb/src/paper/gazelleV1/experiments/train_gazefollow_sasa_ggsf/2026-02-26_15-51-06/epoch_14.pt", help="GazeSpot checkpoint 路径")
    ...
    parser.add_argument("--bbox", nargs=4, type=float, default=[0.0, 0.0, 1, 1], help="真实的人头框: xmin ymin xmax ymax")
